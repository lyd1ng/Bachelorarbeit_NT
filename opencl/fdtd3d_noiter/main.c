...
int main(int argc, char** argv)
{
	...
	while (current_time < max_time)
	{
		...
		//old_e_universe[sid].z = ramped_sinus(current_time, ramped_sin_length * time_step, ramped_sin_amplitude, ramped_sin_frequency);


		old_e_universe[sid].z = sin(2.0 * M_PI * ramped_sin_frequency * current_time);
